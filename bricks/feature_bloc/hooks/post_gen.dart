...
import 'post/add_multibloc_provider.dart';
...
Future<void> run(HookContext context) async {
  ...
  if (context.vars['multibloc_provider'] as bool) {
    await executeAndLog(
      context: context,
      cb: runGeneratedMultiblocProvider,
      message: 'Add multibloc provider in progress ..',
    );
    await Future<void>.delayed(_duration);
  }
