...
Future<void> runGeneratedMultiblocProvider(HookContext context) async {
  ...
  final importLine =
      "import 'package:$appName/src/feature/${featureName.snakeCase}/presentation/bloc/${featureName.snakeCase}_cubit.dart';";

  final blocLine =
      "BlocProvider<${featureName.pascalCase}Cubit>(create: (context) => ${featureName.pascalCase}Cubit()),\n";
  ...
  if (!newContent.contains(importLine)) {
    newContent = newContent.replaceFirst(
        "import 'package:${appName.snakeCase}/src/router/router_cubit.dart';\n",
        "import 'package:${appName.snakeCase}/src/router/router_cubit.dart';\n$importLine\n");
  }
